...
class SaleSubscription(models.Model):
    ...
    def check_service_suspensions(self, partner=None):
        ...
        try:
            ...
            if partner:
                _logger.info('Jacob passed a partner {}'.format(partner))
            ...
            # else default to processing all partner records
                ...
                for service in self.subscriptions:
                    ...
                    _logger.info('Jacob in service in subscription loop')
                    ...
                    _logger.info('Jacob partner matched {}'.format(partner))
                    ...
                    if partner_credit_type == 'fixed':
                        _logger.info('Jacob partner credit type {}'.format(partner_credit_type))
