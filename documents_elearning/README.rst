...
This module provides a documents folder where all the files attached to an elearning
...
* Go to Elearning > Courses (or Contents)
* Create or open a record
* Upload a file as an attachment
* Go to Documents
* Select the Elearning folder
* Select the file uploaded previously. It is linked to the elearning course.
