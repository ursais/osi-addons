...
class AccountReconciliation(models.AbstractModel):
    ...
    def _domain_move_lines_for_reconciliation(self, st_line, aml_accounts, partner_id, excluded_ids=None, search_str=False):
        ...
        res =super(AccountReconciliation, self)._domain_move_lines_for_reconciliation(st_line=st_line,
        ...
        if self._context.get('journal_id',False):
            ...
            if journal and journal.liability_account_id:
                ...
                acc_ids = acc_move_obj.search([('account_id',
                                                        'in',
            ...
            acc_lines_temp = acc_move_obj.search([('account_id','in',acc_ids)]).ids
