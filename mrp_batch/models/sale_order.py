...
class SaleOrder(models.Model):
    ...
    def split_mo(self):
        ...
        for order in self:
            existing_batch = None
            if batch_mode and batch_mode.lower() in ("single", "true", "1", "yes"):
            ...
            # Note: Removed manual commit() - Odoo handles transactions automatically

        return True

    # Methods for Batch Smart Button
    @api.depends("mrp_production_ids", "mrp_production_ids.mrp_batch_id")
