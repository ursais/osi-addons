...
import {
  DomainSelectorBits,
  DomainSelectorBits2,
} from "@advanced_web_domain_widget/domain_selector/domain_selector";
import { DomainSelectorDialogBits, DomainSelectorDialogBits2 } from "@advanced_web_domain_widget/domain_selector_dialog/domain_selector_dialog";
...
export class DomainFieldBits extends Component {
  static template = "web.DomainFieldBits";
  static components = {
    DomainSelectorBits,
  };
  static props = {
...
export class DomainFieldBits2 extends DomainFieldBits {
  onEditDialogBtnClick() {
    // resModel is assumed to be valid here
