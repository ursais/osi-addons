...
class StockRequest(models.Model):
    ...
    def create(self, vals):
        if vals.get("fsm_order_id"):
            ...
            vals.update({"fsm_location_id": order.location_id.id or False})
            ...
            res.update(
                {
                    ...
                    "partner_id": self.helpdesk_ticket_id.fsm_location_id.shipping_address_id.id
                    or self.helpdesk_ticket_id.fsm_location_id.partner_id.id,
                }
            )
        if self.fsm_order_id:
            res.update(
    ...
    def _action_confirm(self):
        for req in self:
            ...
            if (req.procurement_group_id) or (
                ...
                req.procurement_group_id = req.procurement_group_id.id or (
