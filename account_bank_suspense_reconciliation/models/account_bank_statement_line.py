...
class AccountBankStatementLine(models.Model):
    ...
    # reconcile method is removed WIP
    # https://github.com/odoo/odoo/commit/080d41a34119191d20b3e07f72f6aeec677ee1a8#diff-96c5c4fc954f9deb57474d052d9c59b68cc41b610205d342949727ece08ac404
    ...
    def unlink(self):
        ...
        tracked_lines = self.filtered(
            lambda stl: stl.company_id.check_account_audit_trail
        )
        # Custom Code OSI
        tracked_lines.move_id.write({"ref": "Statement line deleted"})
        # Custom Code OSI End
