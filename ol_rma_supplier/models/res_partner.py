...
class ResPartner(models.Model):
    ...
    def action_view_rma_supplier_orders(self):
        ...
        if len(rma_supplier_order_ids) == 1:
            ...
            action["domain"] = [("id", "in", rma_supplier_order_ids.ids)]
