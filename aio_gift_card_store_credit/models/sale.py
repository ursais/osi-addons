...
class SaleOrderLine(models.Model):
    ...
    remaining_sc_amount = fields.Float(string='Remaining SC')
    remaining_gift_amount = fields.Float(string='Remaining Gift Card')
    sc_flag = fields.Boolean('Flag for SC amount', default=False)
    gift_flag = fields.Boolean('Flag for Gift Card amount', default=False)
    ...
    @api.depends('qty_invoiced', 'qty_delivered', 'product_uom_qty', 'order_id.state','remaining_sc_amount','remaining_gift_amount')
    ...
    def _get_invoice_qty(self):
        ...
        for line in self:
            ...
            if (line.sc_flag or line.gift_flag) and (line.remaining_gift_amount>0 or line.remaining_sc_amount>0):
                line.qty_invoiced = 0
