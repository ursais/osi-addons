...
class MRPBom(models.Model):
    ...
    def write(self, vals):
        ...
        restricted_fields = ['product_tmpl_id','product_id','bom_line_ids','product_qty','bom_line_config_ids','operation_ids','type']
        if (any(field in list(vals.keys()) for field in restricted_fields)
            ...
            raise exceptions.ValidationError(_(
                "Cannot update '%s' BOM because either there are no active ECO’s in a stage that allows editing this BOM."
