...
class AccountPayment(models.Model):
    ...
    def _check_make_stub_pages(self):
        ...
        def prepare_vals(invoice, partials):
            ...
            amount_discount = 0.0
            if invoice.invoice_payment_term_id and invoice.invoice_payment_term_id.discount_percentage:

                if (invoice.invoice_date + timedelta(days=int(invoice.invoice_payment_term_id.discount_days))) > self.create_date.date():
                    amount_discount = invoice.amount_total * (invoice.invoice_payment_term_id.discount_percentage / 100)
            payment_total = invoice.amount_total - amount_discount
