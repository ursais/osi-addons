...
class AccountMove(models.Model):
    ...
    # COLUMNS ######
    po_price_difference = fields.Boolean("PO Line Difference",compute="_compute_po_line_price_difference", store=True)
    # END ##########
    ...
    def _compute_po_line_price_difference(self): 
        for move in self: 
            ...
            if move.move_type == 'in_invoice': # Only for Vendor Bills
                po_price_difference = any(line.po_line_price_difference for line in move.line_ids )
