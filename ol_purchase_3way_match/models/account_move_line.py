...
class AccountMoveLine(models.Model):
    ...
    # COLUMNS ######
    po_line_price_difference = fields.Boolean("PO Line Difference",compute="_compute_po_line_price_difference", store=True)
    # END ##########
    ...
    def _compute_po_line_price_difference(self):
        for line in self:
            ...
            if line.purchase_line_id and line.product_id.detailed_type in ['product','consu']: 
