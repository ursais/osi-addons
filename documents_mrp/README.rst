===============================
Documents for Production Orders
===============================
...
This module provides a documents folder where all the files attached to production
...
* Go to Documents
* Select the Manufacturing folder
* Select the file uploaded previously. It is linked to the Manufacturing Order.
