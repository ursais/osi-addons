...
class AccountMoveSend(models.TransientModel):
    ...
    def _get_placeholder_mail_template_dynamic_attachments_data(
        ...
        res = super(
            AccountMoveSend, self
        )._get_placeholder_mail_template_dynamic_attachments_data(move, mail_template)
    ...
    def _prepare_invoice_pdf_report(self, invoice, invoice_data):
        res = super(AccountMoveSend, self)._prepare_invoice_pdf_report(
